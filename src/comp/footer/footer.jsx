  ...
  if (state.succeeded) {
    return (
      ...
      >
          ...
          animationData={done}
        />{" "}
      <h2 style={{marginBottom:  "100px", marginTop:"10px" , marginRight:"30px", marginLeft:"30px"}}>تم الإرسال بنجاح ، سوف نقوم بالتواصل معك في اقرب وقت ممكن</h2>
  ...
  return (
    ...
    >
      <div className="footer ">
        <span>
          {" "}
          Contact <EmailOutlined sx={{ fontSize: "33px" }} />
        </span>
        <form
